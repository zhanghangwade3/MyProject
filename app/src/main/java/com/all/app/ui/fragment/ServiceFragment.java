...
import com.all.app.ui.adapter.ServiceAdpter;
...
public class ServiceFragment extends BaseFragment {
    ...
    public void onResume() {
        super.onResume();
        serviceAdpter = new ServiceAdpter(getActivity(), mDatas);
        lvContent.setAdapter(serviceAdpter);
