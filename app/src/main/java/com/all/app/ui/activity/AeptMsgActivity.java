...
public class AeptMsgActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aept_msg);
    ...
    private void loadData(boolean b) {
        ...
        if (TextUtils.isEmpty(AppData.Init().getLoginBean().getUid())) {
            Toast.makeText(AeptMsgActivity.this, "用户的ID不能为空", Toast.LENGTH_SHORT).show();
            return;
        }
        param.add("type", type);
        param.add("page", page);
        ...
        dealAdpter.setAdpListener(new AdapterBase.IAdpBaseListener() {
            ...
            public void onLazyAdpListener(int key, int position, Object data) {
                if(key==DealAdpter.CLICK_ITEM){
                    ...
                    Intent intent=new Intent(AeptMsgActivity.this,AceptDelActivity.class);
