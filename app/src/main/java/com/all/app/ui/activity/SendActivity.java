...
import com.all.app.ui.adapter.SendAdpter;
...
public class SendActivity extends BaseActivity {
    ...
    private void loadData(boolean b) {
        ...
        if (TextUtils.isEmpty(AppData.Init().getLoginBean().getUid())) {
            Toast.makeText(SendActivity.this, "用户的ID不能为空", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        dealAdpter.setAdpListener(new AdapterBase.IAdpBaseListener() {
            ...
            public void onLazyAdpListener(int key, int position, Object data) {
                if (key == DealAdpter.CLICK_ITEM) {
                    ...
                    Intent intent = new Intent(SendActivity.this, WebSendActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_back:
                startActivity(new Intent(SendActivity.this,MessgeActivity.class));
                break;
            case R.id.tv_title:
                break;
            case R.id.re_title:
