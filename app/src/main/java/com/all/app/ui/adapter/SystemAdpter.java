...
public class SystemAdpter extends AdapterBase<MeageListBean> {

      public SystemAdpter(Context mContext , List<MeageListBean>mDatas){
           super( mContext,mDatas, R.layout.item_system);
      }
    @Override
