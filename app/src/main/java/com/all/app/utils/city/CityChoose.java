...
public class CityChoose {
	...
	public CityChoose(Activity aty) {
		mAty = aty;
	}
	...
	public interface IChooseCityListener {
		public void onFinished(String provinceId, String provinceName, String cityId, String cityName, String areaId, String areaName);
	}
	...
	public void showDialog() {
		...
		dialogView = dialogBuilder.setLayout(R.layout.popu_choose_city).setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT)).commit(mAty);
		...
		wvAreas = (WheelView) dialogView.findViewById(R.id.wv_address_area);
		...
		btn_enter.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String areaName = wheelPs.get(wvProvince.getCurrentItem()).getCityData().get(wvCitys.getCurrentItem()).getAreaData().get(wvAreas.getCurrentItem()).getArea_name();
				String areaId = wheelPs.get(wvProvince.getCurrentItem()).getCityData().get(wvCitys.getCurrentItem()).getAreaData().get(wvAreas.getCurrentItem()).getArea_id();
				chooseCityListener.onFinished(provinceId, provinceName, cityId, cityName, areaId, areaName);
		...
		areaAdapter = new AreaTextAdapter(mAty, wheelPs.get(wvProvince.getCurrentItem()).getCityData().get(wvCitys.getCurrentItem()).getAreaData(), 0, maxsize, minsize);
		...
		wvProvince.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				wvCitys.setViewAdapter(cityAdapter);
				wvCitys.setCurrentItem(0);
				areaAdapter = new AreaTextAdapter(mAty, wheelPs.get(wvProvince.getCurrentItem()).getCityData().get(0).getAreaData(), 0, maxsize, minsize);
				wvAreas.setVisibleItems(5);
				wvAreas.setViewAdapter(areaAdapter);
				wvAreas.setCurrentItem(0);
			}
		...
		wvCitys.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				areaAdapter = new AreaTextAdapter(mAty, wheelPs.get(wvProvince.getCurrentItem()).getCityData().get(wheel.getCurrentItem()).getAreaData(), 0, maxsize, minsize);
				wvAreas.setVisibleItems(5);
				wvAreas.setViewAdapter(areaAdapter);
				wvAreas.setCurrentItem(0);
			}
