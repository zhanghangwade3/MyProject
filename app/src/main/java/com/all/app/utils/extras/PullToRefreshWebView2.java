package com.all.app.utils.extras;
import android.content.Context;
import android.util.AttributeSet;
import android.webkit.WebView;

import com.all.app.utils.pullrefresh.PullToRefreshWebView;
...
public class PullToRefreshWebView2 extends PullToRefreshWebView {
	...
	/*public PullToRefreshWebView2(Context context, PorterDuff.Mode mode) {
		super(context, mode);
	}
*/
