...
public class UnitChooseDate<T> {
	...
	private List<T> arrUnits2;
	TextAdapter textAdapter;



	public interface IChooseUnitListener<String> {
		public void onFinished(java.lang.String p);
	}

	private IChooseUnitListener<String> chooseListener;
	public void setChooseListener(IChooseUnitListener<String> ll) {
		this.chooseListener = ll;
	}

	public UnitChooseDate(Activity aty, List<T> arr, List<T> arr2) {
		mAty = aty;
		this.arrUnits = arr;
		this.arrUnits2 = arr2;
	}
	...
	public void showDialog() {
		...
		dialogView = dialogBuilder
				.setLayout(R.layout.popu_choose_unit2)
				.setLayoutParams(
		...
		wvUnit2 = (WheelView) dialogView.findViewById(R.id.wv_unit2);
		...
		btn_enter.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (chooseListener == null)
					return;
				chooseListener.onFinished(arrUnits.get(wvUnit.getCurrentItem())+ "至"+ arrUnits2.get(wvUnit2.getCurrentItem()));
			}
		});
        ...
        wvUnit2.setVisibleItems(5);
		wvUnit2.setViewAdapter(textAdapter);
		wvUnit2.setCurrentItem(0);

		wvUnit2.addChangingListener(new OnWheelChangedListener() {

			@Override
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				// TODO Auto-generated method stub
				String currentText2 = (String) textAdapter.getItemText(wheel
						.getCurrentItem());
				setTextviewSize(currentText2, textAdapter);
			}
		});

		wvUnit2.addScrollingListener(new OnWheelScrollListener() {
